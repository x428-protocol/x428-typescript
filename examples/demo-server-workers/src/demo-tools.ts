/**
 * Demo tool definitions for the Workers x428 demo server.
 *
 * Inlined here (rather than re-exported from ../../demo-tools.ts) because
 * TypeScript's rootDir constraint prevents importing files outside src/.
 * Keep in sync with examples/demo-tools.ts.
 */
import { z } from "zod";
